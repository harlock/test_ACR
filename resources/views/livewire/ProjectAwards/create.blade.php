      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="">
              <div class="mb-4">
                  ...
                  <input type="date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="exampleFormControlInput1" placeholder="Enter fecha" wire:model="date">
                  @error('date') <span class="text-red-500">{{ $message }}</span>@enderror
                    ...
                    <div class="mb-4">
                        <label for="project_type" class="block text-gray-700 text-sm font-bold mb-2">Premios:</label>
                            <select class="form-control border rounded text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="award_id" wire:model="award_id" required>

...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div>
                <h2 class="font-semibold text-xl">Lista de contenidos de {{ Auth::user()->name }}</h2>
        </div>
            ...
            @endif
            <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Agregar nuevo contenido</button>
            @if($isOpen)
                @include('livewire.Contents.create')
            @endif
            <table class="table-fixed w-full">
                <thead>
                    <tr class="bg-gray-100">
                        <th class="px-4 py-2 w-20">Descripción</th>
                        <th class="px-4 py-2 w-20">Posición</th>
                    </tr>
                </thead>
                <tbody>
